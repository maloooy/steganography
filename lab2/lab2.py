...
class KJBVisualizer(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Метод Скрытого Встраивания")
        self.resize(1200, 700)  # Увеличен размер окна
        self.setStyleSheet("""
            QMainWindow {
    ...
    def init_embed_tab(self):
        ...
        self.tabs.addTab(self.tab_embed, "Встраивание текста")
        ...
        self.btn_select_cover = QPushButton("Открыть исходное изображение")
        ...
        self.txt_input.setPlaceholderText("Введите сообщение для встраивания")
        control_layout.addWidget(self.txt_input)

        group_lambda = QGroupBox("Коэффициент λ (Энергия)")
        ...
        group_seed = QGroupBox("Seed (начальное значение)")
        ...
        self.lbl_diff_all = QLabel("Общее изменение: -")
        control_layout.addWidget(self.lbl_diff_all)

        self.lbl_diff_changed = QLabel("Изменение только в изменённых пикселях: -")
        ...
        group_original = QGroupBox("Исходное изображение")
        layout_original = QVBoxLayout(group_original)
        self.lbl_original_display = QLabel("Нет изображения")
        ...
        group_processed = QGroupBox("Результат встраивания")
        layout_processed = QVBoxLayout(group_processed)
        self.lbl_processed_display = QLabel("Нет изображения")
    ...
    def init_extract_tab(self):
        ...
        self.tabs.addTab(self.tab_extract, "Извлечение текста")
        ...
        self.btn_select_embedded = QPushButton("Выбрать картинку с встраиванием")
        ...
        group_seed_extract = QGroupBox("Seed для извлечения")
        ...
        self.btn_measure_error = QPushButton("Измерить ошибку в извлечении")
        ...
        image_panel = QWidget()
        image_layout = QHBoxLayout(image_panel)
        group_embedded = QGroupBox("Изображение с встраиванием")
        layout_embedded = QVBoxLayout(group_embedded)
        self.lbl_embedded_display = QLabel("Нет изображения")
